...
def prepare_combined_csv():
    dataset_dir = "/home/control-lab/px4_ws/src/custom_msgs/dataset_drone_hard"
    output_csv  = os.path.join(dataset_dir, "dataset_all_hard.csv")
    nominal_mass = 1.0
    ...
    final_data = np.tile(final_data, (3, 1))
